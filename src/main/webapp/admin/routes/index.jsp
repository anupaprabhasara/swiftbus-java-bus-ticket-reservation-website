  ...
  <div class="flex-1 flex flex-col md:ml-60">
    ...
    <main class="flex-1 p-6 space-y-6">
      ...
      <div class="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
        ...
        <a href="${pageContext.request.contextPath}/admin/route?action=create"
        ...
        <div class="relative w-full md:w-1/3">
          <input id="search" type="text" placeholder="Search routes..."
        ...
        <table class="w-full text-sm text-left">
          <thead class="text-xs uppercase bg-gray-700 text-gray-300">
            <tr>
              ...
              <th class="px-6 py-4">Start Location</th>
              <th class="px-6 py-4">End Location</th>
              ...
              <c:when test="${not empty routes}">
                <c:forEach var="route" items="${routes}">
                  <tr class="border-b border-gray-700 hover:bg-gray-700/50">
                    <td class="px-6 py-4">${route.routeId}</td>
                    <td class="px-6 py-4">${route.startLocation}</td>
                    <td class="px-6 py-4">${route.endLocation}</td>
                    <td class="px-6 py-4">Rs. ${route.ticketPrice}</td>
                    <td class="px-6 py-4 text-center space-x-3">
                      <a href="${pageContext.request.contextPath}/admin/route?action=edit&id=${route.routeId}" class="text-green-400 hover:text-green-500">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a href="${pageContext.request.contextPath}/admin/route?action=delete&id=${route.routeId}" onclick="return confirmDelete(this.href);" class="text-red-400 hover:text-red-500">
