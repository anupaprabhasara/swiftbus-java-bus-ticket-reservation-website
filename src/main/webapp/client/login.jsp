      ...
      <div class="max-w-md mx-auto bg-white p-8 rounded-xl shadow-lg space-y-6">
        ...
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-gray-600">
            Or
            <a href="${pageContext.request.contextPath}/signup" class="font-medium text-green-600 hover:text-green-500">
        ...
        <form action="${pageContext.request.contextPath}/login" method="POST" class="space-y-5">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <a href="${pageContext.request.contextPath}/login" class="text-green-600 hover:text-green-500 font-medium">Forgot password?</a>
            </div>
          </div>
